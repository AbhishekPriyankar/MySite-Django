...
class ArticleListViewTest(TestCase):
    ...
    def test_view_url_exists_at_desired_location(self, mock_all):
        # Configure the mock to return an article instance based on sample data.
        mock_article = MagicMock(spec=Article, **self.article_data)
        mock_all.return_value = [mock_article]
    ...
    def test_view_url_accessible_by_name(self, mock_all):
        # Configure the mock to simulate one article.
        mock_article = MagicMock(spec=Article, **self.article_data)
        mock_all.return_value = [mock_article]
